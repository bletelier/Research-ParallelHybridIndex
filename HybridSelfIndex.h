...
private:
	...
	void locateSecOccAuxiliar(ulong l, ulong r, ulong posX, uint m, ulong *nOcc, vector<ulong> &occ, ulong &cont_tid,ulong *currN);
	...
	void locateUptoM(uchar *pat, uint m, ulong *nOcc, ulong **occ, double &tseq, double &tpo, double &tso, double &tps);
	void auxiliarLocateUptoM(uchar *pat, uint m, ulong *nOcc, ulong **occ, int_vector<64> &list, size_t nLoc);
	void parallelLocateUptoM(uchar *pat, uint m, ulong *nOcc, ulong **occ, double &tseq, double &tpo, double &tso, double &tps, vector<ulong> &fo, vector<ulong> &so);
	void newLocateSecOccAuxiliar(ulong l, ulong r, ulong posX, uint m, vector<vector<ulong>> &occ, ulong *cont);
	void newParallelLocateUptoM_1(uchar *pat, uint m, ulong *nOcc, ulong **occ, double &tseq, double &tpo, double &tso, double &tps, vector<ulong> &fo, vector<ulong> &so);
	void newParallelLocateUptoM_2(uchar *pat, uint m, ulong *nOcc, ulong **occ, double &tseq, double &tpo, double &tso, double &tps, vector<ulong> &fo, vector<ulong> &so);
	void newParallelLocateUptoM_3(uchar *pat, uint m, ulong *nOcc, ulong **occ, double &tseq, double &tpo, double &tso, double &tps, vector<ulong> &fo, vector<ulong> &so);
	...
	void calculate_occs_per_thread(vector<ulong> &cont, vector<ulong> &res);
	void calculate_occs_per_thread(ulong *cont, vector<ulong> &res);
...
public:
	...
	void locate(uchar *pat, uint m, ulong *nOcc, ulong **occ, int mode, int mode2, double &tseq, double &tpo, double &tso, double &tps, vector<ulong> &fo, vector<ulong> &so);
